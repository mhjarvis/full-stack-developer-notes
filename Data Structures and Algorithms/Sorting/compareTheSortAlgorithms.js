...
console.log('Execution time for bubbleSort(): ' + time1);
console.log('Execution time for bubbleSortOptimized(): ' + time2);
console.log('Execution time for selectionSort():' + time3);
